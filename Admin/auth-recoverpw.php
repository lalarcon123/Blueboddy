                        ...
                        <div class="d-flex flex-column h-100">
                            <div class="mb-4 mb-md-5 text-center">
                                <a href="index.php" class="d-block auth-logo">
                                    <img src="assets/images/logo-sm.svg" alt="" height="28"> <span class="logo-txt">Blue Boddy</span>
                                </a>
                            </div>
                            <div class="auth-content my-auto">
                                <div class="text-center">
                                    <h5 class="mb-0">Reseteo de Contraseña</h5>
                                ...
                                <form class="mt-4" action="<?php echo htmlentities($_SERVER["PHP_SELF"]); ?>" method="post">
                                    ...
                                    <div class="mb-3 mt-4">
                                        <button class="btn btn-primary w-100 waves-effect waves-light" type='submit' name='submit' value='Submit'>Resetear</button>
                                    </div>
                                </form>
                            ...
                            <div class="mt-4 mt-md-5 text-center">
                                <p class="mb-0">Copyright © <script>
                                    ...
                                    </script> Blueboddy. All rights reserved.</p>
                            </div>
                        </div>
                    </div>
                </div>
