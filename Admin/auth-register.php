                        ...
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="auth-content my-auto">
                                <div class="text-center">
                                    ...
                                    <p class="text-muted mt-2">Obten tu cuenta gratis</p>
                                </div>
                                <form class="needs-validation mt-4 pt-2" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                    ...
                                    <div class="mb-3 <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
                                        ...
                                        <input type="text" class="form-control" id="username" placeholder="Ingrese su usuario" required name="username" value="<?php echo $username; ?>">
                                        <span class="text-danger"><?php echo $username_err; ?></span>
                                    </div>

                                    <div class="mb-3 <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
                                        <label for="userpassword" class="form-label">Contraseña</label>
                                        <input type="password" class="form-control" id="userpassword" placeholder="Ingrese su contraseña" required name="password" value="<?php echo $password; ?>">
                                    ...
                                    <div class="mb-3 <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>">
                                        ...
                                        <input type="password" class="form-control" id="confirm_password" placeholder="Confirmar su contraseña" name="confirm_password" value="<?php echo $confirm_password; ?>">
                                ...
                                <div class="mt-5 text-center">
                                    <p class="text-muted mb-0">Ya tienes una cuenta ? <a href="auth-login.php" class="text-primary fw-semibold"> Ingresar </a> </p>
                                </div>
                            </div>
